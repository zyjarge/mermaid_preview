                ...
                <div className="flex h-screen">
                    <div className="flex-1 flex flex-col">
                        <ResizablePanelGroup direction="horizontal" className="flex-1">
                            <ResizablePanel 
                                defaultSize={isEditorCollapsed ? 0 : editorWidth} 
                                className={`flex flex-col transition-all duration-300 ${isEditorCollapsed ? 'min-w-0 max-w-0 overflow-hidden' : ''}`}
                                style={{
                                    width: isEditorCollapsed ? 0 : undefined,
                                    minWidth: isEditorCollapsed ? 0 : undefined,
                                    maxWidth: isEditorCollapsed ? 0 : undefined,
                                }}
                            >
                            ...
                            {!isEditorCollapsed && <ResizableHandle />}
                            <ResizablePanel defaultSize={isEditorCollapsed ? 100 : (100 - editorWidth)}>
                                <Preview 
                                    className="h-full" 
                                    code={code} 
                                    codeType={codeType} 
